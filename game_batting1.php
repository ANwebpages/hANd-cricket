...
𝗰𝗿𝗶𝗰𝗸𝗲𝘁
    ...
    <p style="font-family: fantasy;font-size:30px;">LEVEL 1</p>
    <p style="font-size: 30px;"> Target score = 10 </p>
    <div class="score">
    ...
    <div id="replay">
        <a href="./game_batting1.php"><button class="replay-button">Replay</button></a>
    </div><br>
    <div>
    <a href="./game_batting2.php"><button class="next-level">Next level</button></a>
</div>
...
<script>
    ...
    function playGame(playerChoice) {
        ...
        if (playerChoice === computerChoice) {
            ...
            else if (target_score==playerScore)
            {   document.getElementById('result').innerText = `OUT! You chose ${playerChoice}. Computer chose ${computerChoice}. Final Score: ${playerScore}`;
            ...
            if(target_score < playerScore){
                condition++;
                document.getElementById('result').innerText = ` Final Score: ${playerScore}`;

...
𝗰𝗿𝗶𝗰𝗸𝗲𝘁
    ...
    <p style="font-family: fantasy;font-size:30px;">LEVEL 6</p>
    <p style="font-size: 30px;"> Target score = 60 </p>
    <div class="score">
    ...
    <div id="replay">
        <a href="./game_batting6.php"><button class="replay-button">Replay</button></a>
    </div><br>
    <div>
        <a href="./game_batting7.php"><button class="next-level">Next level</button></a>
    </div>

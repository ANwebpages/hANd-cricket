...
𝗰𝗿𝗶𝗰𝗸𝗲𝘁
    ...
    <p style="font-family: fantasy;font-size:30px;">LEVEL 9</p>
    <p style="font-size: 30px;"> Target score = 90 </p>
    <div class="score">
    ...
    <div id="replay">
        <a href="./game_batting9.php"><button class="replay-button">Replay</button></a>
    </div><br>
    <div>
        <a href="./game_batting10.php"><button class="next-level">Next level</button></a>
    </div>

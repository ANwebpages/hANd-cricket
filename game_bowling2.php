...
𝗰𝗿𝗶𝗰𝗸𝗲𝘁
    ...
    <p style="font-size: 30px;"> Your score = 90 </p>
    <div class="score">
    ...
    <div id="replay">
        <a href="./game_bowling2.php"><button class="replay-button">Replay</button></a>
    </div><br>
    <div>
        <a href="./game_bowling3.php"><button class="next-level">Next level</button></a>
    </div>

...
𝗰𝗿𝗶𝗰𝗸𝗲𝘁
    ...
    <p style="font-size: 30px;"> Your score = 60 </p>
    <div class="score">
    ...
    <div id="replay">
        <a href="./game_bowling5.php"><button class="replay-button">Replay</button></a>
    </div><br>
    <div>
        <a href="./game_bowling6.php"><button class="next-level">Next level</button></a>
    </div>
